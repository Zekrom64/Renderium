...
public class MatrixStack extends StructStack<@NonNull Matrix4f> {
	...
	public static class Matrix4fAccessor implements IStructAccessor<@NonNull Matrix4f> {
		...
		@Override
		public void read(int position, ByteBuffer buffer, @NonNull Matrix4f struct) {
			struct.set(position, buffer);
		}

		@Override
		public void write(int position, ByteBuffer buffer, @NonNull Matrix4f struct) {
			struct.get(position, buffer);
		}
		
	}
	
	public static final Matrix4fAccessor ACCESSOR = new Matrix4fAccessor();
	...
	public MatrixStack(int size) {
		super(size, ACCESSOR, new Matrix4f());
	}
